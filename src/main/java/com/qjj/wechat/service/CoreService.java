package com.qjj.wechat.service;

import com.qjj.wechat.damain.XmlMessageEntity;
import com.qjj.wechat.damain.message.resp.Article;
import com.qjj.wechat.damain.message.resp.NewsMessage;
import com.qjj.wechat.damain.message.resp.TextMessage;
import com.qjj.wechat.util.MessageUtil;
...
public class CoreService {
	 ...
	 * @return xml
	 */
	public static String processRequest( XmlMessageEntity entity) {
		// xml格式的消息数据
		String respXml = null;
		// 默认返回的文本消息内容
